...
use crate::ui::theme::{
    card_style, pick_list_style, primary_button_style, secondary_button_style, COL_PRIMARY,
    COL_TEXT_DARK, COL_TEXT_MUTED,
};
...
pub fn view<'a>(
    ...
    let monitors_list = monitors.iter().fold(column![].spacing(20), |col, monitor| {
        ...
        let selected_res_option = monitor
            .available_resolutions
            .iter()
            .find(|r| *r == current_res_staging)
            .cloned();
